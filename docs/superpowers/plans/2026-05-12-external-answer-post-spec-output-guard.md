# External Answer Post-Spec Output Guard Hardening Implementation Plan
...
- `tests/test_external_answer_post_spec_output_guard.py`: public allow, local-only projection, no-export block, audit/taskboard CLI tests.
